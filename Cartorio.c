#include <stdio.h> //biblioteca de comuinicação com o usuário
...
int main()
{
  int opcao=0; //Definindo as variáveies 
  int laco=1;
  ...
  switch(opcao) //Inicio da seleção do menu
  {
	...
	case 4:
	printf("Obrigado pro ultilizar o sistema!\n");	
	return 0;
	break;
